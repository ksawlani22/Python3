...
for color in colors:
    ...
    if count == 1:
        sentence = "Thread Shed sold {} thread of {} thread today.".format(count, color)
    else:
        sentence = "Thread Shed sold {} threads of {} thread today.".format(count, color)
    color_sentences.append(sentence)

for sentence in color_sentences:
    print(sentence)
